...
Shader "MudBun/Stopmotion Mesh (URP)"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 SimplexNoiseGradient6_g357( float3 Position, float Size )
			{
				#ifdef MUDBUN_VALID
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 temp_output_35_31 = NormalLs4_g262;
				float3 vertexToFrag94 = temp_output_35_31;
				float3 temp_output_44_0_g354 = ( abs( vertexToFrag94 ) * abs( float3( 0,0,0 ) ) );
				float3 break14_g354 = temp_output_44_0_g354;
				float3 temp_output_36_0_g354 = float3( 0,0,0 );
				...
				float3 Position6_g357 = ( temp_output_35_32 + lerpResult10_g356 );
				float Size6_g357 = _NoiseSize;
				float3 localSimplexNoiseGradient6_g357 = SimplexNoiseGradient6_g357( Position6_g357 , Size6_g357 );
				float3 temp_output_122_0 = ( ( _Displacement * ( (( ( ( ( break14_g354.x > 0.0 ? tex2Dlod( _DisplacementMap, float4( ( ( (temp_output_36_0_g354).yz * _DisplacementMap_ST.xy ) + _DisplacementMap_ST.zw ), 0, 0.0) ) : float4( 0,0,0,0 ) ) * break10_g355.x ) + ( ( break14_g354.y > 0.0 ? tex2Dlod( _DisplacementMap, float4( ( ( (temp_output_36_0_g354).zx * _DisplacementMap_ST.xy ) + _DisplacementMap_ST.zw ), 0, 0.0) ) : float4( 0,0,0,0 ) ) * break10_g355.y ) + ( ( break14_g354.z > 0.0 ? tex2Dlod( _DisplacementMap, float4( ( ( (temp_output_36_0_g354).xy * _DisplacementMap_ST.xy ) + _DisplacementMap_ST.zw ), 0, 0.0) ) : float4( 0,0,0,0 ) ) * break10_g355.z ) + ( color20_g354 * break10_g355.w ) ) / ( break10_g355.x + break10_g355.y + break10_g355.z + break10_g355.w ) )).x - 0.5 ) * temp_output_35_31 ) + ( temp_output_35_0 + ( localSimplexNoiseGradient6_g357 * _OffsetAmount ) ) );
				
				float4 vertexToFrag5_g262 = Color4_g262;
				o.ase_texcoord7 = vertexToFrag5_g262;
				
				float3 vertexToFrag66 = TangentLs4_g262;
				...
				float3 vertexToFrag27_g365 = temp_output_35_0;
				o.ase_texcoord13.xyz = vertexToFrag27_g365;
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_10_0_g369 = vertexToFrag66;
				float3 vertexToFrag94 = IN.ase_texcoord9.xyz;
				float3 temp_output_9_0_g369 = vertexToFrag94;
				float3 temp_output_44_0_g366 = ( float3( 1,1,1 ) * abs( vertexToFrag94 ) );
				float3 break14_g366 = temp_output_44_0_g366;
				float3 vertexToFrag95 = IN.ase_texcoord10.xyz;
				float3 temp_output_36_0_g366 = vertexToFrag95;
				float4 appendResult23_g366 = (float4(temp_output_44_0_g366 , 0.0));
				float4 appendResult24_g366 = (float4(temp_output_44_0_g366 , 1.0));
				float4 break10_g367 = ( ( break14_g366.x + break14_g366.y + break14_g366.z ) > 0.0 ? appendResult23_g366 : appendResult24_g366 );
				float4 color20_g366 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float3 normalizeResult6_g369 = normalize( ( ( cross( temp_output_10_0_g369 , temp_output_9_0_g369 ) * UnpackNormalScale( ( ( ( ( break14_g366.x > 0.0 ? tex2D( _NormalMap, ( ( (temp_output_36_0_g366).yz * _NormalMap_ST.xy ) + _NormalMap_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g367.x ) + ( ( break14_g366.y > 0.0 ? tex2D( _NormalMap, ( ( (temp_output_36_0_g366).zx * _NormalMap_ST.xy ) + _NormalMap_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g367.y ) + ( ( break14_g366.z > 0.0 ? tex2D( _NormalMap, ( ( (temp_output_36_0_g366).xy * _NormalMap_ST.xy ) + _NormalMap_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g367.z ) + ( color20_g366 * break10_g367.w ) ) / ( break10_g367.x + break10_g367.y + break10_g367.z + break10_g367.w ) ), 1.0 ).x ) + ( temp_output_10_0_g369 * UnpackNormalScale( ( ( ( ( break14_g366.x > 0.0 ? tex2D( _NormalMap, ( ( (temp_output_36_0_g366).yz * _NormalMap_ST.xy ) + _NormalMap_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g367.x ) + ( ( break14_g366.y > 0.0 ? tex2D( _NormalMap, ( ( (temp_output_36_0_g366).zx * _NormalMap_ST.xy ) + _NormalMap_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g367.y ) + ( ( break14_g366.z > 0.0 ? tex2D( _NormalMap, ( ( (temp_output_36_0_g366).xy * _NormalMap_ST.xy ) + _NormalMap_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g367.z ) + ( color20_g366 * break10_g367.w ) ) / ( break10_g367.x + break10_g367.y + break10_g367.z + break10_g367.w ) ), 1.0 ).y ) + ( temp_output_9_0_g369 * UnpackNormalScale( ( ( ( ( break14_g366.x > 0.0 ? tex2D( _NormalMap, ( ( (temp_output_36_0_g366).yz * _NormalMap_ST.xy ) + _NormalMap_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g367.x ) + ( ( break14_g366.y > 0.0 ? tex2D( _NormalMap, ( ( (temp_output_36_0_g366).zx * _NormalMap_ST.xy ) + _NormalMap_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g367.y ) + ( ( break14_g366.z > 0.0 ? tex2D( _NormalMap, ( ( (temp_output_36_0_g366).xy * _NormalMap_ST.xy ) + _NormalMap_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g367.z ) + ( color20_g366 * break10_g367.w ) ) / ( break10_g367.x + break10_g367.y + break10_g367.z + break10_g367.w ) ), 1.0 ).z ) ) );
				
				float3 vertexToFrag6_g262 = IN.ase_texcoord11.xyz;
				
				float vertexToFrag8_g262 = IN.ase_texcoord8.w;
				
				float3 temp_output_44_0_g363 = ( abs( vertexToFrag94 ) * abs( float3( 0,0,0 ) ) );
				float3 break14_g363 = temp_output_44_0_g363;
				float3 temp_output_36_0_g363 = float3( 0,0,0 );
				float4 appendResult23_g363 = (float4(temp_output_44_0_g363 , 0.0));
				float4 appendResult24_g363 = (float4(temp_output_44_0_g363 , 1.0));
				float4 break10_g364 = ( ( break14_g363.x + break14_g363.y + break14_g363.z ) > 0.0 ? appendResult23_g363 : appendResult24_g363 );
				float4 color20_g363 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float vertexToFrag7_g262 = IN.ase_texcoord9.w;
				
				float localComputeOpaqueTransparency20_g365 = ( 0.0 );
				...
				float2 ScreenPos20_g365 = (( ( computeScreenPos3_g362 / (computeScreenPos3_g362).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g365 = IN.ase_texcoord13.xyz;
				float3 VertPos20_g365 = vertexToFrag27_g365;
				float localMudBunMeshPoint4_g262 = ( 0.0 );
				...
				float Hash20_g365 = (EmissionHash4_g262).w;
				float AlphaIn20_g365 = (temp_output_25_0_g262).a;
				float AlphaOut20_g365 = 0;
				float AlphaThreshold20_g365 = 0;
				sampler2D DitherNoiseTexture20_g365 = _DitherTexture;
				int DitherNoiseTextureSize20_g365 = _DitherTextureSize;
				int UseRandomDither20_g365 = (int)_RandomDither;
				float AlphaCutoutThreshold20_g365 = _AlphaCutoutThreshold;
				float DitherBlend20_g365 = _Dithering;
				{
				float alpha = AlphaIn20_g365;
				computeOpaqueTransparency(ScreenPos20_g365, VertPos20_g365, Hash20_g365, DitherNoiseTexture20_g365, DitherNoiseTextureSize20_g365, UseRandomDither20_g365 > 0, AlphaCutoutThreshold20_g365, DitherBlend20_g365,  alpha, AlphaThreshold20_g365);
				AlphaOut20_g365 = alpha;
				}
				
				float3 Albedo = temp_output_25_0_g262.rgb;
				float3 Normal = normalizeResult6_g369;
				float3 Emission = ( vertexToFrag6_g262 * (_Emission).rgb );
				float3 Specular = 0.5;
				float Metallic = ( _Metallic * vertexToFrag8_g262 );
				float Smoothness = ( ( 1.0 - (( ( ( ( break14_g363.x > 0.0 ? tex2D( _RoughnessMap, ( ( (temp_output_36_0_g363).yz * _RoughnessMap_ST.xy ) + _RoughnessMap_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g364.x ) + ( ( break14_g363.y > 0.0 ? tex2D( _RoughnessMap, ( ( (temp_output_36_0_g363).zx * _RoughnessMap_ST.xy ) + _RoughnessMap_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g364.y ) + ( ( break14_g363.z > 0.0 ? tex2D( _RoughnessMap, ( ( (temp_output_36_0_g363).xy * _RoughnessMap_ST.xy ) + _RoughnessMap_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g364.z ) + ( color20_g363 * break10_g364.w ) ) / ( break10_g364.x + break10_g364.y + break10_g364.z + break10_g364.w ) )).x ) * ( _Smoothness * vertexToFrag7_g262 ) );
				float Occlusion = 1;
				float Alpha = AlphaOut20_g365;
				float AlphaClipThreshold = AlphaThreshold20_g365;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float3 vertexToFrag27_g365 = temp_output_35_0;
				o.ase_texcoord3.xyz = vertexToFrag27_g365;
				float4 vertexToFrag5_g262 = Color4_g262;
						 ...
						 ) : SV_TARGET
			{
				...
				float4 computeScreenPos3_g362 = ComputeScreenPos( unityObjectToClipPos1_g362 );
				float2 ScreenPos20_g365 = (( ( computeScreenPos3_g362 / (computeScreenPos3_g362).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g365 = IN.ase_texcoord3.xyz;
				float3 VertPos20_g365 = vertexToFrag27_g365;
				float localMudBunMeshPoint4_g262 = ( 0.0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 vertexToFrag27_g365 = temp_output_35_0;
				o.ase_texcoord5.xyz = vertexToFrag27_g365;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 computeScreenPos3_g362 = ComputeScreenPos( unityObjectToClipPos1_g362 );
				float2 ScreenPos20_g365 = (( ( computeScreenPos3_g362 / (computeScreenPos3_g362).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g365 = IN.ase_texcoord5.xyz;
				float3 VertPos20_g365 = vertexToFrag27_g365;
				float localMudBunMeshPoint4_g262 = ( 0.0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 vertexToFrag27_g365 = temp_output_35_0;
				o.ase_texcoord4.xyz = vertexToFrag27_g365;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 computeScreenPos3_g362 = ComputeScreenPos( unityObjectToClipPos1_g362 );
				float2 ScreenPos20_g365 = (( ( computeScreenPos3_g362 / (computeScreenPos3_g362).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g365 = IN.ase_texcoord4.xyz;
				float3 VertPos20_g365 = vertexToFrag27_g365;
				float localMudBunMeshPoint4_g262 = ( 0.0 );
				int VertexID4_g262 = IN.ase_texcoord3.w;
				float3 PositionWs4_g262 = float3( 0,0,0 );
...
/*ASEBEGIN
Version=18909
-1610;245;1302;671;1503.789;851.2172;1.7725;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;107;-1280,-1152;Inherit;True;Property;_DisplacementMap;Displacement Map;11;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;8fb1a6acf59188448bca62119afcccde;False;gray;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;113;-384,-1152;Inherit;False;Mud Triplanar Sample;-1;;354;d9088f0d6015c424b98757b174010394;0;5;36;FLOAT3;0,0,0;False;37;FLOAT3;0,0,0;False;3;SAMPLER2D;0,0,0;False;26;SAMPLERSTATE;0,0,0;False;11;FLOAT3;0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;21;-64,656;Inherit;False;Mud Noise Gradient;-1;;357;ded4656e0e0531448b1f2a26fd64d584;0;3;2;FLOAT3;0,0,0;False;5;FLOAT;0.1;False;7;FLOAT;0.1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SwizzleNode;104;-640,-960;Inherit;False;FLOAT2;2;0;2;3;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SwizzleNode;108;-640,-1056;Inherit;False;FLOAT2;1;2;2;3;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;112;-1024,-1664;Inherit;True;Property;_RoughnessMap;Roughness Map;15;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;5b4f3b34a6be3bd4585c339dff8d1a37;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.OneMinusNode;121;128,-1664;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SwizzleNode;114;-640,-1376;Inherit;False;FLOAT2;0;1;2;3;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;129;0,-512;Inherit;False;URP Normal Helper;-1;;369;ac9d436fdaef92c469abf91a59be3ca9;0;3;8;FLOAT4;0,0,0,0;False;9;FLOAT3;0,0,0;False;10;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TexturePropertyNode;96;-1280,-640;Inherit;True;Property;_NormalMap;Normal Map;13;1;[Normal];Create;True;0;0;0;False;0;False;None;679204acdc00b564398a68f691979695;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FunctionNode;9;-400,864;Inherit;False;Mud Alpha Threshold;-1;;365;926535703f4c32948ac1f55275a22bf0;0;9;8;FLOAT2;0,0;False;15;FLOAT3;0,0,0;False;18;FLOAT;0;False;22;FLOAT;0;False;19;SAMPLER2D;0;False;26;INT;256;False;9;INT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;2;FLOAT;24;FLOAT;25
Node;AmplifyShaderEditor.SwizzleNode;109;-640,-1472;Inherit;False;FLOAT2;2;0;2;3;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SwizzleNode;106;-640,-864;Inherit;False;FLOAT2;0;1;2;3;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;115;-384,-1664;Inherit;False;Mud Triplanar Sample;-1;;363;d9088f0d6015c424b98757b174010394;0;5;36;FLOAT3;0,0,0;False;37;FLOAT3;0,0,0;False;3;SAMPLER2D;0,0,0;False;26;SAMPLERSTATE;0,0,0;False;11;FLOAT3;0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;102;-384,-640;Inherit;False;Mud Triplanar Sample;-1;;366;d9088f0d6015c424b98757b174010394;0;5;36;FLOAT3;0,0,0;False;37;FLOAT3;0,0,0;False;3;SAMPLER2D;0,0,0;False;26;SAMPLERSTATE;0,0,0;False;11;FLOAT3;1,1,1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SwizzleNode;110;-640,-1568;Inherit;False;FLOAT2;1;2;2;3;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=FEF14BB8CC8532C52DFD24941B4C908DDE335B68