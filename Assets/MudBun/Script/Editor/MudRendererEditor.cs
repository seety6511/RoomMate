...
namespace MudBun
{
  ...
  public class MudRendererEditor : MudRendererBaseEditor
  {
    ...
    private void DoLockMesh(Transform t, bool recursive, int depth = 0)
    {
      ...
      renderer.LockMesh(autoRigging, false, null, (MudRendererBase.UVGenerationMode) MeshGenerationUVGeneration.intValue, MeshGenerationWeldVertices.boolValue, optimizeMeshForRendering);
