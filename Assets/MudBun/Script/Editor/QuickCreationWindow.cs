...
namespace MudBun
{
  public class QuickCreationWindow : EditorWindow
  {
    private static readonly float InitWidth = 176.0f; //196.0f;
    private static readonly float InitHeight = 435.0f; //465.0f;
    private static readonly float ButtonSize = 40.0f; //45.0f;
    ...
    public static void Open()
    {
      if (Instance == null)
      {
        Instance = GetWindow<QuickCreationWindow>();
    ...
    private static QuickCreationWindow Instance;
