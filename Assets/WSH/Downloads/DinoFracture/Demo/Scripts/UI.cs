    ...
    public class UI : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (!hitButton && Input.GetMouseButtonDown(0))
            {
                ...
                GameObject cannonBall = (GameObject)Instantiate(CannonBallTemplate, ray.origin + ray.direction.normalized * 0.1f, Quaternion.identity, GameRoot.Instance.Main.transform.Find("CannonBallParent"));
